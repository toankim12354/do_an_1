		<?php
						...
						$sql = "SELECT ma ,ho_ten FROM khach_hang where email = '$email'and mat_khau ='$matkhau'";
						/*echo $sql;*/
						$kq = mysqli_query($con,$sql);
						if(mysqli_num_rows($kq) == 0){
						$sai= "Tài khoản hoạc mật khẩu không trính xác ";
						}
						else{ 
			...
			<div id="row2">
				...
				<h2 class="title">Đăng nhập </h2>
						...
						<form action="" method="POST">
							<span style="color: red;margin: 340px;">	
							<?php 	if (isset($sai)) {
								echo $sai;
							} ?>
							</span>
							<table border="1" align="center" style="">
								...
								<tr>
									<td colspan="2" align="center">
										...
										<button  ><a href="trang_chu.php">hủy  </a>  </button>
										<button> <a href="trangDK.php">Đăng ký  </a> </button>
