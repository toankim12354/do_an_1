<?php
	...
	$sql = "SELECT * FROM san_pham WHERE ma_danh_muc=5;";
	...
	$sql = "SELECT * FROM san_pham WHERE ma_danh_muc=5 LIMIT $so_san_pham_tren_trang OFFSET $so_san_pham_bo_qua";
	...
	<body>
		...
		<div class="trang-chu">
			...
			<div id="row2">
				...
				<div id="right">
					...
					<div class="right-row1-row1">
						...
						<div class="item-right">
							...
							<p>Thị trường:<span class="gia_gach">450000đ</span></p>
							<p>Giá bán:<span class="gia_do"><?php echo $sp['gia_sp'] ?>vnd</span></p>
				...
				<br>
				<div>
					<a href="?trang=<?= ($trang_hien_tai > 1) ? $trang_hien_tai - 1 : 1 ?>">pre</a>
					<?php 	for ($i	= 1; $i <= $so_trang ; $i++) { ?>
					<a  style="display: inline-block; width: 20px;" href="?trang=<?= $i?>"><?= $i ?></a>
					<?php } ?>
					<a href="?trang=<?= ($trang_hien_tai < $so_trang) ? $trang_hien_tai + 1 : $so_trang ?>">next</a>
				</div>
			</div>
		</div>
